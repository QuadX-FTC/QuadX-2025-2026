...
@Config
@Autonomous(name = "ExodusAutoRed", group = "Autonomous")
public class ExodusAutoRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder traj2 = traj1.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-18, 22), Math.toRadians(90));
        ...
        TrajectoryActionBuilder traj4 = traj3.endTrajectory().fresh()
                .setTangent(Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(-11, 52), Math.toRadians(180))
                .strafeToSplineHeading(new Vector2d(-46, 32), Math.toRadians(128));


        TrajectoryActionBuilder traj5 = traj4.endTrajectory().fresh()
                .setTangent(Math.toRadians(270))
                .strafeToLinearHeading(new Vector2d(5, 22), Math.toRadians(90));


        TrajectoryActionBuilder traj6 = traj5.endTrajectory().fresh()
                .setTangent(Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(5, 49), Math.toRadians(90));


        Action trajectoryActionCloseOut = traj6.endTrajectory().fresh()
                .setTangent(Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(6, 50), Math.toRadians(0))
