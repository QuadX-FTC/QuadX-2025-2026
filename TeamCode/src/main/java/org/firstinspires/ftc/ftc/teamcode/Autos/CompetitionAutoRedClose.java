...
public class CompetitionAutoRedClose extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder traj1 = drive.actionBuilder(initialPose)
                .strafeToSplineHeading(new Vector2d(55, 10), Math.toRadians(150));
        ...
        TrajectoryActionBuilder traj4 = traj3.endTrajectory().fresh()
                .strafeToSplineHeading(new Vector2d(55, 10), Math.toRadians(157));

        TrajectoryActionBuilder traj5 = traj4.endTrajectory().fresh()
                .strafeToSplineHeading(new Vector2d(11, 28), Math.toRadians(90));
                ...
                new SequentialAction(
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        ...
                                        new ParallelAction(
                                                traj3.build(),
                                                intake.runForDuration(1, -0.7, 2.8)
                                        ),
                                        traj4.build(),
                                        intake.runForDuration(1, 1, 1),
                                        intake.runForDuration(-0.3, 1, 1),
